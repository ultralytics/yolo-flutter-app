...
class PoseEstimator(
    ...
    init {
        ...
        if (!labelsWereLoaded) {
            Log.w("PoseEstimator", "No embedded labels found from appended ZIP or FlatBuffers. Using labels passed via constructor.")
                        ...
                        try {
                            ...
                            if (data != null && data.containsKey("names")) {
                                ...
                                if (namesMap != null) {
                                    ...
                                    Log.d("PoseEstimator", "Names map is null")
                                }
                            } else {
                                Log.d("PoseEstimator", "Data is null or doesn't contain 'names'")
                            }
                        } catch (ex: Exception) {
