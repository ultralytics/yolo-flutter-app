...
public class SwiftYoloPlatformView: NSObject, FlutterPlatformView, FlutterStreamHandler {
  ...
  private func updateThresholds(confidenceThreshold: Double, iouThreshold: Double?) {
    ...
    print(
      "SwiftYoloPlatformView: Updating thresholds - confidence: \(confidenceThreshold), IoU: \(String(describing: iouThreshold))"
    )
    ...
    methodChannel.setMethodCallHandler { [weak self] (call, result) in
      ...
      case "setThresholds":
          ...
          let confidenceThreshold = args["confidenceThreshold"] as? Double
        {
          ...
          print(
            "SwiftYoloPlatformView: Received setThresholds call with confidence: \(confidenceThreshold), IoU: \(String(describing: iouThreshold))"
          )
