...
void main() {
  ...
  group('YoloView Missing Coverage Tests', () {
    ...
    testWidgets('result callback with detection data', (
      WidgetTester tester,
    ) async {
      ...
      if (state.widget.onResult != null) {
        final results = [
          YOLOResult.fromMap(
            mockEvent['detections']![0] as Map<String, dynamic>,
          ),
        ];
    ...
    testWidgets('widget handles null callbacks gracefully', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(
        const MaterialApp(
    ...
    testWidgets(
      'widget creation with different task types covers parsing branches',
    ...
    testWidgets('GlobalKey access for method coverage', (
      WidgetTester tester,
    ) async {
    ...
    testWidgets('widget with complex callback scenarios', (
      WidgetTester tester,
    ) async {
