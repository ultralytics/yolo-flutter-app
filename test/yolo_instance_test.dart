...
void main() {
  ...
  group('YOLO Instance ID Tests', () {
    const MethodChannel defaultChannel = MethodChannel(
    ...
    setUp(() {
      ...
      TestDefaultBinaryMessengerBinding.instance.defaultBinaryMessenger
          .setMockMethodCallHandler(defaultChannel, (
    ...
    test('Create and manage multiple instances', () async {
      ...
      final createCalls = methodCalls
          .where((call) => call.method == 'createInstance')
          .toList();
    ...
    test('Load models for different instances', () async {
      ...
      final loadCalls = methodCalls
          .where((call) => call.method == 'loadModel')
          .toList();
    ...
    test('Run inference on different instances', () async {
      ...
      final predictCalls = methodCalls
          .where((call) => call.method == 'predictSingleImage')
          .toList();
    ...
    test('Dispose instances', () async {
      ...
      final disposeCalls = methodCalls
          .where((call) => call.method == 'disposeInstance')
          .toList();
      ...
      final allDisposeCalls = methodCalls
          .where((call) => call.method == 'disposeInstance')
          .toList();
    ...
    test('Backward compatibility with default instance', () async {
      ...
      final yolo = YOLO(modelPath: 'yolov8n.tflite', task: YOLOTask.detect);
