...
| Android NPU (opt-in) | QNN `*_v73/_v81_qnn.onnx`     | [yolo-flutter-app `models-v1.0.0`](https://github.com/ultralytics/yolo-flutter-app/releases/tag/models-v1.0.0) |
...
Use `--upload --repo ultralytics/yolo-flutter-app --tag models-v1.0.0` to publish generated `.tflite` assets to the
canonical Android model release. Generate the matching QNN assets with `scripts/export-qnn-models.py`. The Core ML
assets are generated by `../yolo-ios-app/scripts/export-models.py` and hosted on the iOS `models-v1.0.0` release.
