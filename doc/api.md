...
| `useGpu`            | `bool`                  | ❌       | `true`  | Allow GPU acceleration on Android (LiteRT 2.x GPU → CPU ladder); iOS uses the Neural Engine through Core AI or Core ML. Set `false` to force CPU |
