...
`YOLO.officialModels()` 查看当前平台可用的全部官方 ID。Android TFLite
统一从 Flutter `v0.2.0` release 下载，iOS Core ML 统一从 YOLO iOS
`v8.3.0` release 下载，后续包版本发布不会改变模型 URL。
...
Android TFLite 示例资产来自 [yolo-flutter-app `v0.2.0`](https://github.com/ultralytics/yolo-flutter-app/releases/tag/v0.2.0)，
iOS Core ML 示例资产来自 [yolo-ios-app `v8.3.0`](https://github.com/ultralytics/yolo-ios-app/releases/tag/v8.3.0)。
