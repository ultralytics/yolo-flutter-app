...
public class SwiftYoloPlatformView: NSObject, FlutterPlatformView, FlutterStreamHandler {
    ...
    init(
        ...
        if let dict = args as? [String: Any],
           ...
           let taskRaw = dict["task"] as? String {
            ...
            print("SwiftYoloPlatformView: Received thresholds - confidence: \(confidenceThreshold), IoU: \(iouThreshold), old: \(oldThreshold)")
    ...
    private func setupYOLOView(confidenceThreshold: Double, iouThreshold: Double) {
        ...
        // Debug information
        print("SwiftYoloPlatformView: setupYOLOView - Setting up detection callback with confidenceThreshold: \(confidenceThreshold), iouThreshold: \(iouThreshold)")
    ...
    private func updateThresholds(confidenceThreshold: Double, iouThreshold: Double?, numItemsThreshold: Int? = nil) {
        guard let yoloView = yoloView else { return }
        
        print("SwiftYoloPlatformView: Updating thresholds - confidence: \(confidenceThreshold), IoU: \(String(describing: iouThreshold)), numItems: \(String(describing: numItemsThreshold))")
    ...
    private func setupMethodChannel() {
        ...
        methodChannel.setMethodCallHandler { [weak self] (call, result) in
            guard let self = self else {
                result(FlutterError(code: "not_available", message: "YoloPlatformView was disposed", details: nil))
                return
            }
            ...
            case "setThreshold":
                ...
                if let args = call.arguments as? [String: Any],
                   let threshold = args["threshold"] as? Double {
                    ...
                    result(FlutterError(code: "invalid_args", message: "Invalid arguments for setThreshold", details: nil))
                }
            ...
            case "setConfidenceThreshold":
                ...
                if let args = call.arguments as? [String: Any],
                   let threshold = args["threshold"] as? Double {
                    print("SwiftYoloPlatformView: Received setConfidenceThreshold call with value: \(threshold)")
                    ...
                    result(FlutterError(code: "invalid_args", message: "Invalid arguments for setConfidenceThreshold", details: nil))
                }
            ...
            case "setIoUThreshold", "setIouThreshold":
                ...
                if let args = call.arguments as? [String: Any],
                   let threshold = args["threshold"] as? Double {
                    ...
                    result(FlutterError(code: "invalid_args", message: "Invalid arguments for setIoUThreshold", details: nil))
                }
            ...
            case "setNumItemsThreshold":
                ...
                if let args = call.arguments as? [String: Any],
                   let numItems = args["numItems"] as? Int {
                    ...
                    result(FlutterError(code: "invalid_args", message: "Invalid arguments for setNumItemsThreshold", details: nil))
                }
            ...
            case "setThresholds":
                ...
                if let args = call.arguments as? [String: Any],
                   let confidenceThreshold = args["confidenceThreshold"] as? Double {
                    ...
                    print("SwiftYoloPlatformView: Received setThresholds call with confidence: \(confidenceThreshold), IoU: \(String(describing: iouThreshold)), numItems: \(String(describing: numItemsThreshold))")
                    self.updateThresholds(
                    ...
                    result(FlutterError(code: "invalid_args", message: "Invalid arguments for setThresholds", details: nil))
                }
            ...
            case "setShowUIControls":
                ...
                if let args = call.arguments as? [String: Any],
                   let show = args["show"] as? Bool {
                    ...
                    result(FlutterError(code: "invalid_args", message: "Invalid arguments for setShowUIControls", details: nil))
                }
