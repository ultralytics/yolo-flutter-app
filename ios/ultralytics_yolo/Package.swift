...
let package = Package(
  ...
  dependencies: [
    ...
    // Mirrors the CocoaPods `s.dependency 'UltralyticsYOLO', '>= 8.9.12', '< 9.0'` range in the podspec.
    .package(url: "https://github.com/ultralytics/yolo-ios-app.git", "8.9.12"..<"9.0.0")
  ],
  targets: [
    .target(
      name: "ultralytics_yolo",
